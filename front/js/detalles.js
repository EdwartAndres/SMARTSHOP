        ...
        success: function (respuesta) {
            ...
            for (i = 0; i < respuesta.length; i++) {
                tabla.innerHTML +=
                    ...
                    '</td><td>' +
                    respuesta[i].comprar.cod_Compra +
                    '</td><td>' +
...
function insertarDetalle() {
    ...
    var pago = $("#pago").val();
    var codProducto = $("#codProducto option:selected").val();
    var codCompra = $("#codCompra option:selected").val();
...
function cargarDetalle(codigo) {
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            $("#codProducto").val(respuesta.productos.cod_Producto).attr('selected', 'selected');
            $("#codCompra").val(respuesta.comprar.cod_Compra).attr('selected', 'selected');
...
$(document).ready(function () {
    let selectCodProducto = document.querySelector('#codProducto')
    let selectCodCompra = document.querySelector('#codCompra')

    selectCodProducto.innerHTML = ''
    selectCodCompra.innerHTML = ''
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            for (i = 0; i < respuesta.length; i++) {
                selectCodProducto.innerHTML += '<option value="' + respuesta[i].cod_Producto + '">' +
